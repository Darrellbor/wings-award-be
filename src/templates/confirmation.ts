...
export const confirmationEmail = async (
  ...
  const mailBody = `
    ...
    <html>
        ...
        <body style="font-family: 'Open Sans', sans-serif;margin: auto;max-width: 550px;margin-top: 50px;">
            <div class="Mailer">
                ...
                <div class="Mailer__content" style="margin-top: 30px;margin-left: 26px;line-height: 1.8rem;letter-spacing: 0.4px;">
                    Hello there,<br>
                    You recently used this email to vote on the wings award 2021 platform
                </div>
